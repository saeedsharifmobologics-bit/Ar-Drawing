...
import com.example.ardrawing.adsManger.AppOpenManager
import com.example.ardrawing.adsManger.BillingManager
import com.example.ardrawing.adsManger.RemoteConfigManager
...
class ArApp : Application() {
    ...
    override fun onCreate() {
        ...
        billingManager = BillingManager(
            context = this,
            productIds = listOf("aikeyboard_weekly", "aikeyboard_monthly", "aikeyboard_yearly"),
